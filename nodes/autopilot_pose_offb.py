...
precision_alt = 0.1 #10 cm d'écart par rapport à la distance voulue #temporaire parce que erreur de mesure sur le simulateur avec alt negative au demarrage
precision_ang = 3 #3 degre d'ecart par rapport à l'angle voulu
...
class AutopilotOffboardNode:
	...
	"""
	fonction pour renvoyer le drone à ça position d'origine
	"""
	def home(self):
		print("home")
		flag_depassement = False
